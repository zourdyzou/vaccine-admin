...
export const VaccineChart: React.FunctionComponent<VaccineChartTypes> = ({ chartData }) => {
    const data = {
        labels: [
        ...
        datasets: [
            {
                ...
                borderColor: ['rgba(241, 90, 34, 1)', 'rgba(194, 249, 112, 1)', 'rgb(255,0,90)'],
                borderWidth: 1,
            },
        ],
    };
    ...
    return (
        <div className="w-full md:w-[400px] border p-3 bg-white">
